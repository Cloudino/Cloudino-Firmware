...
<li><a href=\"javascript:cdino.seg('mdns');\">mDNS Service Discovery</a></li>\n\
<li><a href=\"#\" onclick=\"jscript.style.display=((jscript.style.display=='none')?'':'none');\">JavaScript Configuration</a></li>\n\
<ul id=\"jscript\" style=\"display:none\">\n\
<li><a href=\"javascript:cdino.seg('jscript');\">Initial Script</a></li>\n\
<li><a href=\"javascript:cdino.seg('jsterm');\">JavaScript Terminal</a></li>\n\
</ul>\n\
<li><a href=\"#\" onclick=\"server.style.display=((server.style.display=='none')?'':'none');\">Server Configuration</a></li>\n\
...
<li style=\"display:none\"><a href=\"javascript:cdino.seg('srv_blynk');\">Blynk Server</a></li>\n\
</ul>\n\
<li><a href=\"javascript:cdino.seg('sys');\">System Tools</a></li>\n\
</ul>\n\
</aside>\n\
...
void resetEEPROM()
{
    ...
    strcpy(configuration.cdino_dns,"cloudino.io");
...
String addtrrad(String prop, String name, bool value)
{
  ...
  return addtr(prop, "<input type=\"radio\" name=\""+name+"\" value=\"0\" "+f+"> False <input type=\"radio\" name=\""+name+"\" value=\"1\" "+t+"> True");
}

String addtrinp(String prop, String type, String name, String value, int min=0, int max=50)
{
  return addtr(prop, "<input type=\""+type+"\" name=\""+name+"\" minlength=\""+min+"\" maxlength=\""+max+"\" value=\""+value+"\">");
}

String  addbutton(String value, String onclick)
{
  return "<input onclick=\""+onclick+"\" type=\"button\" value=\""+value+"\">\n";    
}
...
void handleSegMDNS()
{
    ...
    ret+="<form>\n";
    ret+="<table class=\"table\">\n";    
    ret+=addtrinp(F("mDNS"),"text","mdns_dns",configuration.mdns_dns,0,15);
    ret+=addtrinp(F("TTL"),"number","mdns_ttl",String(configuration.mdns_ttl));
    ret+="</table>\n";
...
void handleSegJScript()
{
    ...
    ret+="</header>\n";
    ret+="<section>\n";
    ret+=F("<textarea id=\"js_script\" style=\"width:100%; height:250px;\">");
    ...
    ret+="</textarea>\n";
    ret+=F("<span><input type=\"button\" onclick=\"cdino.getHtml('jsinit',null,'POST','['+js_script.value);\" value=\"Save\"></span>\n");
    ret+="</section>\n";
    webserver.send( 200, "text/html; charset=utf-8", ret);
} 
...
void handleSegCloudino()
{
    ...
    ret+="<section>\n";
    ret+=F("<p>This is the Cloudino Cloud Configuration page, to get these information you need to register in <a href=\"http://cloudino.io\">cloudino.io</a></p>\n");
    ret+="<form>\n";
    ret+="<table class=\"table\">\n";
    //addtr("Status","ON");
...
void loopWebServer()
{
  ...
  if(millis()-_time>=5000)
  {
    ...
    if(!jsInited)
    {
        //Serial.print("JavaScript Code Initialized...");
        jsInited=true;
        int s=configuration.js_size;
        if(s>10000)s=0;
        if(s>0)
